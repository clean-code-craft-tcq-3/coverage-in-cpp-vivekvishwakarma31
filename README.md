...
My Mindset has been changed to write the code and solving problems.
Now while writing the code I think with these methods: eliminating if/else Switch case ladder, reducing the complexity , reducing the CCN values,writing a readble code instead of just working code, SRP principle , Writing a code testable and cover all possible test cases through unit testing.
